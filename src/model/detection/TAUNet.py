...
from src.model.detection.utils.AttentionLayers import  SAttention
...
class TAUNet(nn.Module):
    ...
    def __init__(self, input_channels, hidden_channels, n_classes):
        ...
        self.mha = SAttention(hidden_channels, num_heads=8, patch_size=1)
...
class UpBlock(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels1, mid_channels2, out_channels, kernel_size=2):
        ...
        self.cmha = SAttention(mid_channels1, num_heads=8, patch_size=1)
